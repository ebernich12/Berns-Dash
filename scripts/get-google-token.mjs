/**
 * Run once to get your Google Calendar refresh token.
 * Usage: node scripts/get-google-token.mjs
 *
 * It will open your browser, you click Allow, and it saves
 * GOOGLE_REFRESH_TOKEN to .env.local automatically.
 */
...
function saveRefreshToken(filePath, token) {
...
const server = http.createServer(async (req, res) => {
  ...
  if (!code) {
    res.end('No code received'); return
  }
  ...
  saveRefreshToken(ENV_PATH, tokens.refresh_token)
